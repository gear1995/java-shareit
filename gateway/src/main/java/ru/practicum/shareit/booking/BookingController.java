...
public class BookingController {
    ...
    public ResponseEntity<Object> updateBookingStatus(@PathVariable final long bookingId,
    ...
    @GetMapping("owner")
    public ResponseEntity<Object> getAllOwnerBookingsByState(@RequestParam(name = "state", defaultValue = "all") String stateParam,
